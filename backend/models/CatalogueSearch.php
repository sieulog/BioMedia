...
/**
 * CatalogueSearch represents the model behind the search form about `common\models\Catalogue`.
 */
class CatalogueSearch extends Catalogue
{
    ...
    public function rules()
    {
        return [
            ...
            [['title', 'slug', 'image', 'download', 'content', 'meta_title', 'meta_keywords', 'meta_description'], 'safe'],
        ];
    }
