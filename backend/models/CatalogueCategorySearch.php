...
/**
 * CatalogueCategorySearch represents the model behind the search form about `common\models\CatalogueCategory`.
 */
class CatalogueCategorySearch extends CatalogueCategory
{
    /**
     * @inheritdoc
     */
