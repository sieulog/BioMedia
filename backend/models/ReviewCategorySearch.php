...
/**
 * ReviewCategorySearch represents the model behind the search form about `common\models\ReviewCategory`.
 */
class ReviewCategorySearch extends ReviewCategory
{
    /**
     * @inheritdoc
     */
