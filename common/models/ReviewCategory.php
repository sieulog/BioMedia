...
/**
 * This is the model class for table "review_category".
 *
 * @property integer $id
 ...
 */
class ReviewCategory extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * @inheritdoc
     * @return ReviewCategoryQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new ReviewCategoryQuery(get_called_class());
    }
