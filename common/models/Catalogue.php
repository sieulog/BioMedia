...
class Catalogue extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['content'], 'string'],
            [['title', 'slug', 'image', 'download', 'meta_keywords'], 'string', 'max' => 255],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'download' => Yii::t('backend', 'Download'),
    ...
    /**
     * @inheritdoc
     * @return CatalogueQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new CatalogueQuery(get_called_class());
    }
}
